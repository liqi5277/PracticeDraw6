    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (animated) {
                    imageView.animate().translationX(0).setDuration(durationSb.getProgress() * 300);
                } else {
                    imageView.animate().translationX(Utils.dpToPixel(100)).setDuration(durationSb.getProgress() * 300);
                }
                animated = !animated;
            }
        });
